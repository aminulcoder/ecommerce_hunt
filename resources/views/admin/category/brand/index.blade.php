     ...
     <form action="{{ route('brand.store') }}" method="Post" enctype="multipart/form-data" id="add-form">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input id="brand_name" type="text" class="form-control"  name="brand_name" required="">
            <small  class="form-text text-muted">This is your brand Name</small>
          </div>
          <div class="form-group">
            <label for="brand_logo">Brand Logo</label>
            <input id="brand_logo" type="file" class="form-control dropify"  name="brand_logo" required="">
